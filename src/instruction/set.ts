...
import { IInstruction, IInstructionEncoder, IInstructionExecutor, IInstructionSet } from './interfaces'
...
class InstructionSet implements IInstructionSet {
  ...
  public getEncoder (name: string): IInstructionEncoder {
    ...
    throw new Error(`Unable to find instruction encoder for the instruction '${name}'.`)
  }

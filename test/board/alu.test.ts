...
describe('test sub() function', () => {
  ...
  test('tests for C flag for sub() function', () => {
    ...
    r = sub(w1, w2)
    expect(r.result).toEqual(Word.fromUnsignedInteger(9))
    expect(r.result).toEqual(Word.fromSignedInteger(9))
    expect(r.flags[Flag.Z]).toBe(false)
    expect(r.flags[Flag.N]).toBe(false)
    expect(r.flags[Flag.V]).toBe(false)
    expect(r.flags[Flag.C]).toBe(true)
  ...
  test('tests for V flag for sub() function', () => {
    w1 = Word.fromSignedInteger(-2147483648)
    w2 = Word.fromSignedInteger(10)
    r = sub(w1, w2)
    expect(r.result).toEqual(Word.fromUnsignedInteger(2147483638))
    expect(r.result).toEqual(Word.fromSignedInteger(2147483638))
    expect(r.flags[Flag.Z]).toBe(false)
    expect(r.flags[Flag.N]).toBe(false)
    expect(r.flags[Flag.V]).toBe(true)
    expect(r.flags[Flag.C]).toBe(true)
...
describe('test mul() function', () => {
  test('test that mul() function returns correct result', () => {
    ...
    w2 = Word.fromUnsignedInteger(4294967295)
    r = mul(w1, w2)
    expect(r.result).toEqual(Word.fromUnsignedInteger(1))
    expect(r.result).toEqual(Word.fromSignedInteger(1))
    expect(r.flags[Flag.Z]).toBe(false)
    expect(r.flags[Flag.N]).toBe(false)
    expect(r.flags[Flag.V]).toBe(undefined)
    ...
    w1 = Word.fromSignedInteger(-2147483648)
    w2 = Word.fromSignedInteger(-2147483648)
    r = mul(w1, w2)
    expect(r.result).toEqual(Word.fromUnsignedInteger(0))
    expect(r.result).toEqual(Word.fromSignedInteger(0))
    expect(r.flags[Flag.Z]).toBe(true)

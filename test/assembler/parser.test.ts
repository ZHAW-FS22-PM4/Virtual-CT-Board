...
describe('parse code', function () {
  it('can parse assembler code', function () {
    ...
    expect(ast.areas[0].instructions[0].line).toBe(3)
    ...
    expect(ast.areas[1].instructions[0].line).toBe(5)
    ...
    expect(ast.areas[1].instructions[1].line).toBe(6)
    ...
    expect(ast.areas[1].instructions[2].line).toBe(8)
  })
})

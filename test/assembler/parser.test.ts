...
describe('parse code', function () {
  ...
  it('can parse SPACE and FILL instruction with multiplication', function () {
    const loadCode = `
    AREA myCode, CODE, READONLY
             STR R4, [R5]
        SPACE 8*8
  ...
  it('can parse SPACE and FILL instruction with addition', function () {
    const loadCode = `
    AREA myCode, CODE, READONLY
             STR R4, [R5]
        SPACE 8+8
  ...
  it('can parse SPACE and FILL instruction with addition and brackets', function () {
    const loadCode = `
    AREA myCode, CODE, READONLY
             STR R4, [R5]
        SPACE 8*(2+2)

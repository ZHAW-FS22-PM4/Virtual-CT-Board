...
describe('parse code', function () {
  it('can parse assembler code', function () {
    ...
    expect(ast.areas[0].instructions[0].line).toEqual({ from: 3, to: 3 })
    ...
    expect(ast.areas[1].instructions[0].line).toEqual({ from: 5, to: 5 })
    ...
    expect(ast.areas[1].instructions[1].line).toEqual({ from: 6, to: 6 })
    ...
    expect(ast.areas[1].instructions[2].line).toEqual({ from: 8, to: 8 })
  })
})

...
beforeEach(function () {
  ...
  registers.writeRegister(
    Register.R1,
    Word.fromUnsignedInteger(0b10000000000000000000010010101101)
  )
  registers.writeRegister(
    Register.R2,
    Word.fromUnsignedInteger(0b10000000000000000000010010101101)
  ...
  registers.writeRegister(
    Register.R3,
    Word.fromUnsignedInteger(0b11111111111111111111111111111111)
  )
  registers.writeRegister(
    Register.R4,
    Word.fromUnsignedInteger(0b11111111111111111111111111111111)
...
describe('test canEncodeInstruction function for MVNS', () => {
  it('should encode be able to instruction with correct register information', () => {
    expect(
      mvnsInstruction.canEncodeInstruction('MVNS', ['R1', 'R7'])
    ).toBeTruthy()
  })

  it('should not be able to encode instruction with wrong instruction name', () => {
    expect(
      mvnsInstruction.canEncodeInstruction('MVN', ['R1', 'R1', 'R7'])
    ).toBeFalsy()
  })
})
...
describe('test encode instruction function for MVNS', () => {
  it('should create correct opcode for MVNS R1, R7', () => {
    ...
    expect(opcode[0].toBinaryString()).toEqual('0100001111111001')
  })
  ...
  it('should throw an error for high register params', () => {
    expect(() => mvnsInstruction.encodeInstruction(['R1', 'R8'])).toThrow()
  })
})
...
describe('test executeInstruction function for MVNS', () => {
  it('should return correct value from register for MVNS R1, R2,', () => {
    ...
    expect(registers.readRegister(Register.R1).value).toEqual(
      0b01111111111111111111101101010010
    )
  ...
  it('should return correct value from register for MVNS R5, R6 and set N flag.,', () => {
    ...
    expect(registers.readRegister(Register.R5).value).toEqual(
      0b11111111111110111101100001010100
    )
